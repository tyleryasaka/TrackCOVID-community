...
module.exports = {
  'translation': {
    ...
    'statusNegativeMessage': 'No transmission paths from infected individuals to you have been discovered at this time. However, everyone is at risk and individuals should follow the directives of the Public Health departmrnt, Ministry of Health, and local governments.',
    'statusPositiveMessage': 'A possible transmission path from an infected individual to you has been discovered. You should take precautionary measures to protect yourself and others, according to the directives of the Public Health authority & local, state, and federal governments.',
